...
ALLOWED_HOSTS = [os.getenv('DOMAIN_1'), os.getenv('DOMAIN_2'), os.getenv('IP_1'), 'localhost', '127.0.0.1', os.getenv('FRONT_END_IP')]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        "blog.auth.CookieJWTAuthentication",            # <- our fallback
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://blog-daisyui2.fly.dev",  # Sveltekit online frontend
]
